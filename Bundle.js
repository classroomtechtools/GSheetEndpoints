...
class DeveloperMetadata extends APIBase {
  ...
  search (additionalMixins) {
    ...
    const mixin = {
      ...
      byLocationType(type, sheetId, {metadataKey=null, metadataValue=null, visibility=null}) {
        const obj = {
        ...
        if (metadataKey) obj.metadataKey = metadataKey;
        if (metadataValue) obj.metadataValue = metadataValue;
        if (visibility) obj.visibility = visibility;
        return this.add(obj);
      },

      bySpreadsheetLoc({metadataKey=null, metadataValue=null, visibility=null}) {
        const obj = {
      ...
      bySheetLoc: function ({metadataKey=null, metadataValue=null}) {
        const obj = {
          locationType: "SHEET"
        };
        if (metadataKey) obj.metadataKey = metadataKey;
...
class Spreadsheets extends APIBase {
  ...
  batchUpdate ({includeSpreadsheetInResponse=false, responseRanges=[], responseIncludeGridData=false}={}) {
    ...
    const mixin = {
      ...
      addSheet (name, properties={}) {
        properties.title = name;
        return this.add('addSheet', {
          properties
        }, null);
      },

      updateSheetProperties (sheetId, properties, fields) {
        properties.sheetId = sheetId;
        return this.add('updateSheetProperties', {
          properties
        }, fields);
      },

      moveDimension (sheetId, sourceIndex, destinationIndex) {
        if (sourceIndex === destinationIndex) return;   // no need to move
        return this.add('moveDimension', {
          source: {
            sheetId,
            dimension: 'COLUMNS',
      ...
      createMetaData: function ({metadataId=null, metadataKey=null, metadataValue=null}={}, {location=null, visibility=null}={}) {
        ...
        return this.add('createDeveloperMetadata', {
          developerMetadata: {
      ...
      updateMetaData(metadataId, {metadataKey=null, metadataValue=null}={}, {visibility=null}={}) {
        const md = {};
        const fields = [];
        if (metadataKey) {
          md.metadataKey = metadataKey;
          fields.push('metadataKey');
        }
        if (metadataValue) {
          md.metadataValue = metadataValue;
        ...
        return this.add('updateDeveloperMetadata', {
          dataFilters: [{
  ...
  getByDataFilter () {  
    ...
    const mixin = {
      addRow (sheetId, startRowIndex, endRowIndex) {
        this.payload.dataFilters.push({
          gridRange: {
            sheetId: sheetId,
            startRowIndex,
      ...
      addColumn (sheetId, startColumnIndex, endColumnIndex) {
        this.payload.dataFilters.push({
          gridRange: {
            sheetId: sheetId,
            startColumnIndex,
...
class Values extends APIBase {
  ...
  batchUpdateByDataFilter ({
    ...
    const mixin = {
      ...
      addGridRange (gridRange, {majorDimension="ROWS", values=[]}={}) {
        this.payload.data.push({
          dataFilter: {
            gridRange
          },
